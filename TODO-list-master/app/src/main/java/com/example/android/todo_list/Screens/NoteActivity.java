...
public class NoteActivity extends AppCompatActivity implements View.OnClickListener, NoteAdapter.onItemClickListner {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_NOTE_REQUEST && resultCode == RESULT_OK){
            ...
            String note_prio=data.getStringExtra("note_prio");
            String note_repeat=data.getStringExtra("note_repeat");

            noteViewModel.insert(new Note(note_title,note_description,note_priority,note_prio,note_repeat));
            ...
            Note note = new Note(note_title,note_description,note_priority,note_prio,note_repeat);
            note.setId(note_id);
    ...
    public void onItemClick(Note note) {
        ...
        intent.putExtra("prio",note.getPriority());
